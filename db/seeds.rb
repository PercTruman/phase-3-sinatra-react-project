...
@lord_of_virulence = ArmyModel.create(name:"lord_of_virulence", image_url:" https://www.games-workshop.com/en-US/Death-Guard-Lord-of-Virulence-2020", number_in_collection: 1, cost_per_box: 38, unit_points_cost:120, army_id:1)
...
@kabalite_warriors = ArmyModel.create(name:"kabalite_warriors", image_url:"https://www.games-workshop.com/en-US/Drukhari-Kabalite-Warriors-2017", number_in_collection: 40, cost_per_box: 38, unit_points_cost: 80, army_id: 2)
@swarmlord = ArmyModel.create(name:"swarmlord", image_url:"https://www.games-workshop.com/en-US/The-Swarmlord-2019", number_in_collection: 1, cost_per_box: 60, unit_points_cost:240, army_id:3)
